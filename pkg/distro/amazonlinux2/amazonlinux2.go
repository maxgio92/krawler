...
func (a *AmazonLinux2) Configure(config distro.Config, vars map[string]interface{}) error {
	a.config = config
	a.vars = vars
...
func (a *AmazonLinux2) GetPackages(filter p.Filter) ([]p.Package, error) {
...
func (a *AmazonLinux2) buildMirrorURLs(mirrors []p.Mirror, versions []distro.Version) ([]*url.URL, error) {
...
func (a *AmazonLinux2) buildVersions(mirrors []p.Mirror, staticVersions []distro.Version) ([]distro.Version, error) {
...
func (a *AmazonLinux2) crawlVersions(mirrors []p.Mirror, debug bool) ([]distro.Version, error) {
...
func (a *AmazonLinux2) buildRepositoriesURLs(roots []*url.URL, repositories []p.Repository, vars map[string]interface{}) ([]*url.URL, error) {
	var urls []*url.URL
...
func (a *AmazonLinux2) buildRepositoriesURIs(repositories []p.Repository, vars map[string]interface{}) ([]string, error) {
	uris := []string{}
