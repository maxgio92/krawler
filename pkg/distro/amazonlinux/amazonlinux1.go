...
type AmazonLinux1 struct {
	config distro.Config
	vars   map[string]interface{}
}

func (a *AmazonLinux1) Configure(config distro.Config, vars map[string]interface{}) error {
	a.config = config
	a.vars = vars
...
func (a *AmazonLinux1) GetPackages(filter p.Filter) ([]p.Package, error) {
...
func (a *AmazonLinux1) buildMirrorURLs(mirrors []p.Mirror, versions []distro.Version) ([]*url.URL, error) {
...
func (a *AmazonLinux1) buildVersions(mirrors []p.Mirror, staticVersions []distro.Version) ([]distro.Version, error) {
...
func (a *AmazonLinux1) crawlVersions(mirrors []p.Mirror, debug bool) ([]distro.Version, error) {
...
func (a *AmazonLinux1) buildRepositoriesURLs(roots []*url.URL, repositories []p.Repository, vars map[string]interface{}) ([]*url.URL, error) {
	var urls []*url.URL
...
func (a *AmazonLinux1) buildRepositoriesURIs(repositories []p.Repository, vars map[string]interface{}) ([]string, error) {
	uris := []string{}
