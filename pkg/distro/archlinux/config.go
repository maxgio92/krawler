...
func (a *ArchLinux) buildConfig(def distro.Config, user distro.Config) (distro.Config, error) {
...
//
//nolint:unparam
func (a *ArchLinux) mergeConfig(def distro.Config, config distro.Config) (distro.Config, error) {
...
func (a *ArchLinux) sanitizeConfig(config *distro.Config) error {
...
func (a *ArchLinux) sanitizeMirrors(mirrors *[]packages.Mirror) error {
