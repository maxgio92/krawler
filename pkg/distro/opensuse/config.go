...
func (f *OpenSuse) buildConfig(def distro.Config, user distro.Config) (distro.Config, error) {
...
//
//nolint:unparam
func (f *OpenSuse) mergeConfig(def distro.Config, config distro.Config) (distro.Config, error) {
...
func (f *OpenSuse) sanitizeConfig(config *distro.Config) error {
...
func (f *OpenSuse) sanitizeMirrors(mirrors *[]packages.Mirror) error {
