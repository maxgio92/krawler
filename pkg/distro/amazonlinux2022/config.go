...
func (a *AmazonLinux2022) buildConfig(def distro.Config, user distro.Config) (distro.Config, error) {
...
func (a *AmazonLinux2022) mergeConfig(def distro.Config, config distro.Config) (distro.Config, error) {
...
func (a *AmazonLinux2022) sanitizeConfig(config *distro.Config) error {
...
func (a *AmazonLinux2022) sanitizeMirrors(mirrors *[]packages.Mirror) error {
